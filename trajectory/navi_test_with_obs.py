...
from evaluation.xxx_eval_simulation import utils
...
start_goal_pos = pickle.load(open("../evaluation/xxx_eval_simulation/eval_positions.p", "rb"))
robot_position = start_goal_pos[0][7][:2]
target_init_pos = start_goal_pos[1][7]
